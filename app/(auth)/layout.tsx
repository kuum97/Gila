...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex flex-col max-w-[420px] gap-5 bg-white_light tall:w-[420px]">
      ...
      <div className="fixed bottom-0 p-4 border-t border-gray-300 w-full max-w-[420px]">
        <BackButton />
      </div>
    </div>
  );
