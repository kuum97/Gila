...
export default function SharePopover({ activityId }: { activityId: string }) {
  const url = `${process.env.NEXT_PUBLIC_BASE_URL}/sharedFolder/${activityId}`;
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="bg-white w-full flex gap-4">
        ...
        <div className="w-8 h-8 rounded-full flex justify-center items-center bg-[#F9E000] shadow-md">
